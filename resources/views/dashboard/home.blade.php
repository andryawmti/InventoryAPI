        ...
        <div class="row">
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card flex-row align-items-center align-items-stretch border-0">
                    ...
                    <div class="col-8 py-3 bg-primary rounded-right">
                        <div class="h2 mt-0">{{ $count_of_user }}</div>
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card flex-row align-items-center align-items-stretch border-0">
                    ...
                    <div class="col-8 py-3 bg-purple rounded-right">
                        <div class="h2 mt-0">{{ $count_of_admin }}</div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12">
                ...
                <div class="card flex-row align-items-center align-items-stretch border-0">
                    ...
                    <div class="col-8 py-3 bg-green rounded-right">
                        <div class="h2 mt-0">{{ $count_of_api_call_today }}</div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12">
                ...
                <div class="card flex-row align-items-center align-items-stretch border-0">
                    ...
                    <div class="col-8 py-3 bg-green rounded-right">
                        <div class="h2 mt-0">{{ $count_of_api_call_all }}</div>
                        ...
                        <div class="card card-default">
                            ...
                            <div class="list-group" data-height="180" data-scrollable="">
                                ...
                                <div class="list-group-item list-group-item-action">
                                    <div class="media">
                                        <img class="align-self-start mx-2 circle thumb32" src="{{asset('angleadmin/img/user/02.jpg')}}" alt="Image">
                                ...
                                <div class="list-group-item list-group-item-action">
                                    <div class="media">
                                        <img class="align-self-start mx-2 circle thumb32" src="{{asset('angleadmin/img/user/03.jpg')}}" alt="Image">
                                        <div class="media-body text-truncate">
                                            <p class="mb-1">
                                                <strong class="text-primary">
                                                    <span class="circle bg-success circle-lg text-left"></span>
                                ...
                                <div class="list-group-item list-group-item-action">
                                    <div class="media">
                                        <img class="align-self-start mx-2 circle thumb32" src="{{asset('angleadmin/img/user/09.jpg')}}" alt="Image">
                                        <div class="media-body text-truncate">
                                            <p class="mb-1">
                                                <strong class="text-primary">
                                ...
                                <div class="list-group-item list-group-item-action">
                                    <div class="media">
                                        <img class="align-self-start mx-2 circle thumb32" src="{{asset('angleadmin/img/user/12.jpg')}}" alt="Image">
                                        <div class="media-body text-truncate">
                                            <p class="mb-1">
                                                <strong class="text-primary">
                                                    <span class="circle bg-danger circle-lg text-left"></span>
                                ...
                                <div class="list-group-item list-group-item-action">
                                    <div class="media">
                                        <img class="align-self-start mx-2 circle thumb32" src="{{asset('angleadmin/img/user/10.jpg')}}" alt="Image">
                                        <div class="media-body text-truncate">
                                            <p class="mb-1">
                                                <strong class="text-primary">
                                                    <span class="circle bg-danger circle-lg text-left"></span>
